Ext.data.JsonP.Sch_panel_TimelineTreePanel({
  "subclasses": [
    "Gnt.panel.Gantt",
    "Sch.panel.SchedulerTree"
  ],
  "html_filename": "TimelineTreePanel.html",
  "docauthor": null,
  "singleton": false,
  ...
  "members": {
    ...
    "method": [
      ...
      },
      {
        ...
        "linenr": 250,
        "deprecated": null,
        "doc": "<p>The <a href=\"#/api/Sch.panel.TimelineTreePanel-cfg-readOnly\" rel=\"Sch.panel.TimelineTreePanel-cfg-readOnly\" class=\"docClass\">readOnly</a> accessor. Use it to switch the <code>readonly</code> state.</p>\n"
      },
      {
        "params": [
          {
      ...
      },
      {
        ...
        "linenr": 284,
        "deprecated": null,
        "doc": "<p>Switches the current header preset. See the <a href=\"#/api/Sch.preset.Manager\" rel=\"Sch.preset.Manager\" class=\"docClass\">Sch.preset.Manager</a> for details. Will fire the <a href=\"#/api/Sch.panel.TimelineTreePanel-event-beforeviewchange\" rel=\"Sch.panel.TimelineTreePanel-event-beforeviewchange\" class=\"docClass\">beforeviewchange</a> event.\nReturning <code>false</code> from the listener will cancel the switch.</p>\n"
      }
    ],
    "css_var": [
    ...
    "cfg": [
      ...
      },
      {
        ...
        "linenr": 111,
        "deprecated": null,
        "doc": "<p>Template used to show a tooltip over a scheduled item, null by default (meaning no tooltip). The tooltip will be populated with the data in\nrecord corresponding to the hovered element. See also <a href=\"#/api/Sch.panel.TimelineTreePanel-cfg-tipCfg\" rel=\"Sch.panel.TimelineTreePanel-cfg-tipCfg\" class=\"docClass\">tipCfg</a>.</p>\n"
      },
      {
        "type": "Object",
        "html_filename": "TimelinePanel.html",
  ...
  "static": false,
  "href": "TimelineTreePanel.html#Sch-panel-TimelineTreePanel",
  "component": false,
  "protected": false,
  "inheritable": false,
  "alternateClassNames": [
  ...
  "filename": "../ExtScheduler2.x/js/Sch/panel/TimelineTreePanel.js",
  "private": false,
  "xtypes": [

  ],
  "alias": null,
  "name": "Sch.panel.TimelineTreePanel",
