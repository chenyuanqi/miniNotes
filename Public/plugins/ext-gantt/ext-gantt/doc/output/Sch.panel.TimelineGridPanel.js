Ext.data.JsonP.Sch_panel_TimelineGridPanel({
  "subclasses": [
    "Sch.panel.SchedulerGrid"
  ],
  "html_filename": "TimelineGridPanel.html",
  "docauthor": null,
  "singleton": false,
  ...
  "members": {
    ...
    "method": [
      ...
      },
      {
        ...
        "linenr": 250,
        "deprecated": null,
        "doc": "<p>The <a href=\"#/api/Sch.panel.TimelineGridPanel-cfg-readOnly\" rel=\"Sch.panel.TimelineGridPanel-cfg-readOnly\" class=\"docClass\">readOnly</a> accessor. Use it to switch the <code>readonly</code> state.</p>\n"
      },
      {
        "params": [
          {
      ...
      },
      {
        ...
        "linenr": 284,
        "deprecated": null,
        "doc": "<p>Switches the current header preset. See the <a href=\"#/api/Sch.preset.Manager\" rel=\"Sch.preset.Manager\" class=\"docClass\">Sch.preset.Manager</a> for details. Will fire the <a href=\"#/api/Sch.panel.TimelineGridPanel-event-beforeviewchange\" rel=\"Sch.panel.TimelineGridPanel-event-beforeviewchange\" class=\"docClass\">beforeviewchange</a> event.\nReturning <code>false</code> from the listener will cancel the switch.</p>\n"
      }
    ],
    "css_var": [
    ...
    "cfg": [
      ...
      },
      {
        ...
        "linenr": 111,
        "deprecated": null,
        "doc": "<p>Template used to show a tooltip over a scheduled item, null by default (meaning no tooltip). The tooltip will be populated with the data in\nrecord corresponding to the hovered element. See also <a href=\"#/api/Sch.panel.TimelineGridPanel-cfg-tipCfg\" rel=\"Sch.panel.TimelineGridPanel-cfg-tipCfg\" class=\"docClass\">tipCfg</a>.</p>\n"
      },
      {
        "type": "Object",
        "html_filename": "TimelinePanel.html",
  ...
  "static": false,
  "href": "TimelineGridPanel.html#Sch-panel-TimelineGridPanel",
  "component": false,
  "protected": false,
  "inheritable": false,
  "alternateClassNames": [
  ...
  "filename": "../ExtScheduler2.x/js/Sch/panel/TimelineGridPanel.js",
  "private": false,
  "xtypes": [

  ],
  "alias": null,
  "name": "Sch.panel.TimelineGridPanel",
