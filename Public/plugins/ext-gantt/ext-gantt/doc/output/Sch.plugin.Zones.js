Ext.data.JsonP.Sch_plugin_Zones({
  "subclasses": [
    "Gnt.feature.WorkingTime",
    "Sch.plugin.TimeGap"
  ],
  "html_filename": "Zones.html",
  "docauthor": null,
  "singleton": false,
  ...
  "static": false,
  "href": "Zones.html#Sch-plugin-Zones",
  "component": false,
  "protected": false,
  "inheritable": false,
  "alternateClassNames": [
  ...
  "filename": "../ExtScheduler2.x/js/Sch/plugin/Zones.js",
  "private": false,
  "xtypes": [

  ],
  "alias": null,
  "name": "Sch.plugin.Zones",
  ...
  "linenr": 11,
  "deprecated": null,
  "doc": "<p>Plugin for showing \"global\" zones in the scheduler grid, these can by styled easily using just CSS.\nTo populate this plugin you need to pass it a store having the <code>Sch.model.Range</code> as the model.</p>\n\n<p><p><img src=\"doc-resources/scheduler/images/scheduler-grid-horizontal.png\" alt=\"\"></p></p>\n\n<p>To add this plugin to scheduler:</p>\n\n<pre><code>    var zonesStore = Ext.create('Ext.data.Store', {\n        model   : 'Sch.model.Range',\n        data    : [\n            {\n                StartDate   : new Date(2011, 0, 6),\n                EndDate     : new Date(2011, 0, 7),\n                Cls         : 'myZoneStyle'\n            }\n        ]\n    });\n\n    var scheduler = Ext.create('Sch.panel.SchedulerGrid', {\n        ...\n\n        resourceStore   : resourceStore,\n        eventStore      : eventStore,\n\n        plugins         : [\n            Ext.create('Sch.plugin.Zones', { store : zonesStore })\n        ]\n    });\n</code></pre>\n"
});