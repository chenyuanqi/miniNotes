Ext.data.JsonP.Sch_mixin_TimelineView({
  "subclasses": [
  ...
  "static": false,
  "href": "TimelineView.html#Sch-mixin-TimelineView",
  "component": false,
  "protected": false,
  "inheritable": false,
  "alternateClassNames": [
  ...
  "linenr": 10,
  "deprecated": null,
  "doc": "<p>A base mixing for Ext.view.View classes, giving to the consuming view the \"time line\" functionality.\nThis means that the view will be capabale to display a list of \"events\", ordered on the <a href=\"#/api/Sch.data.TimeAxis\" rel=\"Sch.data.TimeAxis\" class=\"docClass\">time axis</a>.</p>\n\n<p>By itself this mixin is not enough for correct rendering. The class, consuming this mixin, should also consume one of the\n<a href=\"#/api/Sch.view.Horizontal\" rel=\"Sch.view.Horizontal\" class=\"docClass\">Sch.view.Horizontal</a> or <a href=\"#/api/Sch.view.Vertical\" rel=\"Sch.view.Vertical\" class=\"docClass\">Sch.view.Vertical</a> mixins, which provides the implementation of some orientation-specfic methods.</p>\n\n<p>Generally, should not be used directly, if you need to subclass the view, subclass the <a href=\"#/api/Sch.view.SchedulerGridView\" rel=\"Sch.view.SchedulerGridView\" class=\"docClass\">Sch.view.SchedulerGridView</a> or <a href=\"#/api/Sch.view.SchedulerTreeView\" rel=\"Sch.view.SchedulerTreeView\" class=\"docClass\">Sch.view.SchedulerTreeView</a>\ninstead.</p>\n"
});